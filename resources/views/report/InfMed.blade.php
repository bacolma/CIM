...
<body>
    ...
    @php
    $campos = array("motcon","texenf","vitres","exalab","exarad","exapre","exaesp","resexalab",
    ...
    $titulos = array("motcon"=>"Motivo Consulta", "texenf"=>"Enfermedad Actual","otrobs"=>"Diagnósticos",
        ...
        "exalab"=>"Examenes Laboratorio", "exarad"=>"Exámenes Radiológicos","exaesp"=>"Exámenes Especiales",
