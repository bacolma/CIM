...
<nav>
    <div class="nav nav-tabs" id="tabMenu"  role="tablist">
        <a class="nav-link text-dark bg-primary active" id="navTabPac1" data-toggle="tab" role="tab" href="#tabpac1" aria-controls="tabpac1" aria-selected="true">Datos Personales</a>
        <a class="nav-link text-dark bg-primary" id="navTabPac2" data-toggle="tab" role="tab" href="#tabpac2" aria-controls="tabpac2" aria-selected="false">Dirección</a>
        <a class="nav-link text-dark bg-primary" id="navTabPac3" data-toggle="tab" role="tab" href="#tabpac3" aria-controls="tabpac3" aria-selected="false">Antecedentes</a>
    </div>
</nav>
<div><br></div>
<div class="tab-content" id="tabConten">
    ...
    <div class="tab-pane fade" id="tabpac2" role="tabpanel" aria-labelledby="NavTabPac2">
        ...
        <div class="row">
            <div class="col">
                ...
                <textarea id="dirhab" name="dirhab" class="form-control" rows="3" cols="20">{{$pacient->dirofc}}</textarea>
            </div>
            <div class="col">
    ...
    <a class="btn btn-primary" id="btnRon" href="{{route('paciente.edit', [$pacient->id])}}">Completar/Modificar Datos</a>
